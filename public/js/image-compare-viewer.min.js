  ...
  return (function (t) {
      ...
      o("inspectSource", function (t) {
        ...
        (t.exports = function (t, n, e, o) {
          var s = !!o && !!o.unsafe,
            ...
            f = !!o && !!o.noTargetGet;
          "function" == typeof e &&
            ("string" != typeof n || c(e, "name") || i(e, "name", n),
            (l(e).source = d.join("string" == typeof n ? n : ""))),
            t !== r
              ? (s ? !f && t[n] && (u = !0) : delete t[n],
                u ? (t[n] = e) : i(t, n, e))
              : u
              ? (t[n] = e)
              : a(n, e);
        ...
        if (
          (C &&
            ...
            v !== Object.prototype &&
              ...
              (l ||
                i(x) === v ||
                (c ? c(x, v) : "function" != typeof x[g] && s(x, g, y)),
              a(x, _, !0, !0),
              l && (d[_] = y))),
          "values" == p &&
            j &&
          ...
          else r({ target: n, proto: !0, forced: h || E }, w);
        return w;
      };
    },
    function (t, n, e) {
    ...
    function (t, n, e) {
      ...
      var r = e(5),
        ...
        rt = function (t, n) {
          ...
          return (
            G(e, { type: "Symbol", tag: t, description: n }),
            c || (e.description = n),
            e
          );
        },
        ...
        at = function (t) {
          ...
          return (
            !(this === D && u(J, n) && !u($, n)) &&
            (!(e || !u(this, n) || !u(J, n) || (u(this, B) && this[B][n])) || e)
          );
        },
        st = function (t, n) {
          var e = v(t),
          ...
          if (e !== D || !u(J, r) || u($, r)) {
            var o = z(e, r);
            return (
              !o || !u(J, r) || (u(e, B) && e[B][r]) || (o.enumerable = !0), o
            );
          }
        },
        ut = function (t) {
      ...
      a ||
        (L(
          (H = function () {
            ...
            var t =
              ...
              e = function (t) {
                this === D && e.call($, t),
                  u(this, B) && u(this[B], n) && (this[B][n] = !1),
                  et(this, n, g(1, t));
              };
            return c && nt && et(D, n, { configurable: !0, set: e }), rt(n, t);
          }).prototype,
          "toString",
          function () {
            return W(this).tag;
        ...
        c &&
          ...
          i || L(D, "propertyIsEnumerable", at, { unsafe: !0 })),
        (M.f = function (t) {
          return rt(P(t), t);
        })),
        ...
        H.prototype[N] || E(H.prototype, N, H.prototype.valueOf),
        I(H, "Symbol"),
        (C[B] = !0);
    },
    function (t, n) {
    ...
    function (t, n, e) {
      ...
      var r = e(5),
        o = e(37).filter;
      r(
        { target: "Array", proto: !0, forced: !e(52)("filter") },
        {
          filter: function (t) {
    ...
    function (t, n, e) {
      ...
      t.exports = function (t) {
        ...
        if (
          ...
          for (e = new v((n = a(p.length))); n > m; m++)
            s(e, m, y ? g(p[m], m) : p[m]);
        else
          for (
            d = (l = b.call(p)).next, e = new v();
            !(f = d.call(l)).done;
            m++
          )
    ...
    function (t, n, e) {
      ...
      t.exports =
        ...
        o(function () {
          ...
          ? function (t, n) {
              for (
                var e = s(t), o = arguments.length, f = 1, l = c.f, d = a.f;
                o > f;
        ...
        h = function (t, n) {
          if (c) {
            ...
            if (
              ...
              var e = { targetElement: t, options: n || {} };
              (a = [].concat(r(a), [e])),
          ...
          (this.settings = Object.assign(
            {
              ...
              addCircleBlur: !0,
              showLabels: true,
              labelOptions: { before: "Avant", after: "Après", onHover: !1 },
              smoothing: !0,
              smoothingAmount: 100,
              hoverStart: !1,
              verticalMode: !1,
                ...
                o >= 0 &&
                  ...
                  this.settings.fluidMode
                    ? this.settings.verticalMode
                      ...
                      : (this.wrapper.style.clipPath = "inset(0 0 0 ".concat(
                          o,
                          "%)"
                        ))
                    : this.settings.verticalMode
              ...
              value: function () {
                ...
                n.classList.add("icv__label", "icv__label-before", "keep"),
                  ...
                  this.settings.labelOptions.onHover &&
                    (n.classList.add("on-hover"), e.classList.add("on-hover")),
                  this.settings.verticalMode &&
                    (n.classList.add("vertical"), e.classList.add("vertical")),
                      ...
                      '<svg\n      height="15"\n      width="15"\n       style="\n       transform: \n       scale('
                        ...
                        .concat(
                          this.settings.addCircle
                            ? 'fill="transparent"'
                            : 'fill="'.concat(this.settings.controlColor, '"'),
                          '\n       stroke="'
                        )
                        .concat(
            ...
            },
            {
              ...
              value: function () {
                ...
                for (var r = 0; r <= 1; r++) {
                  var o = e[r];
                  if (
                    (o.classList.add("icv__img"),
                    o.classList.add(0 === r ? "icv__img-a" : "icv__img-b"),
                    1 === r)
                  ) {
                    var i = document.createElement("div"),
                      c = e[1].src;
                    i.classList.add("icv__wrapper"),
                      (i.style.cssText = "\n            width: "
                        .concat(
                ...
                if (this.settings.fluidMode) {
                  ...
                  s.classList.add("icv__fluidwrapper"),
                    (s.style.cssText =
